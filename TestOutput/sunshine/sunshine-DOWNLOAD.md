...
#  Code
The code for this app can be found in the [sunshine](https://github.com/udacity/ud851-Exercises/tree/student/sunshine) folder of the [Toy App Repository](https://github.com/udacity/ud851-Exercises).
